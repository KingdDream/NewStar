    ...
    <div class="conversationBox">
        <div class="conversationLeft">
            <div class="search-list">
                <div>
                    <span>通话时长：</span>
                    <input type="text" v-model="searchData.searchCall" name placeholder="不限" class="startTime" />
                    <b></b>
                ...
                <div>
                    <span>日期：</span>
                    <el-date-picker v-model="searchData.searchDate" value-format="yyyy-MM-dd" type="date"
        ...
        <div class="conversationRight" v-if="pieData==null?false:true">
            <div>
                <PieChilds myEcharts="jt" :echartData="pieData.called_ok_ratio" titleName="接通率" />
                <PieChilds myEcharts="dh" :echartData="pieData.call_loss_ratio" titleName="掉话率" />
                <PieChilds myEcharts="hj" :echartData="pieData.call_ok_ratio" titleName="呼叫成功率" />
            </div>
            <div>
        ...
        <confirmMask v-if="confirmMaskShow" @cancelUser="cancelUser" title="确认删除本条数据吗？"></confirmMask>
    </div>
</template>
