...
//导出
export const toExcelCall= p => get('call/toExcel', p); //通话
export const toExcelUe= p => get('ue/toExcel', p); //终端
export const toExcelSystem= p => get('system/toExcel', p); //系统
export const toExcelWaring= p => get('warningLog/toExcel', p); //终端告警
export const toExcelDaily= p => get('dailyLog/toExcel', p); //日志